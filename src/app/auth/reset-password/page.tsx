...
import { ResetPasswordForm, NeonAuthUIProvider, authLocalization } from "@neondatabase/auth/react/ui";
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#0a0a0b] p-6">
      ...
      <div className="relative z-10 w-full max-w-[440px] space-y-8">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-white/40">Enter your new password below to regain access to your account.</p>
        </div>
